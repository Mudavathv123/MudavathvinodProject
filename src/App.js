...
class App extends Component {
  ...
  componentDidMount() {
    this.timerId = setInterval(this.timerChnage, 1000)
  }
  ...
  imageChange = id => {
    ...
    const imgValue = imagesList.filter(eachImage => eachImage.id === id)
  ...
  filterActiveTabImges() {
    const {activeTabId} = this.state
    const filterImagesIs = imagesList.filter(
      eachImage => eachImage.category === activeTabId,
    )
    return filterImagesIs
  }

  render() {
    const filterImagesIs = this.filterActiveTabImges()
    const {activeTabId, score, timerInSec, img, isTrue} = this.state
    return (
            ...
            <li className="score-container">
              ...
              <div className="time-container">
                <img
                  ...
                  alt="timer"
                />
                <p className="time">{timerInSec} sec</p>
              </div>
            </li>
          </ul>
        </nav>
        <div className="container">
          {!isTrue && (
            <div className="game-container">
              <img src={img} className="big-img" alt="match" />
          ...
          {isTrue && (
            <div className="trofy-container">
              <div className="trofy-bg">
                <img
                  src="https://assets.ccbp.in/frontend/react-js/match-game-trophy.png"
                  alt="trophy"
                />
                <p className="your-score-head">Your Score</p>
