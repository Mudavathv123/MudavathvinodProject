...
const ShowAllTrendingEpisodeCard = props => {

    const { trendingEpisode } = props
    const { albumArtist, albumName, albumImageUrl, albumId } = trendingEpisode;
...
export default ShowAllTrendingEpisodeCard